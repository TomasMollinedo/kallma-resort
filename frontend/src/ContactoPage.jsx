...
function Contacto() {
  ...
  return (
    <div className="h-screen w-screen relative flex items-center justify-center overflow-hidden">
      ...
      {/* 🧡 Contenido principal */}
      <div className="relative z-10 flex flex-col md:flex-row bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-8 max-w-5xl w-[90%]">
        {/* 📨 Formulario */}
        ...
        {/* 🗺️ Mapa */}
        <div className="md:w-1/2 w-full md:pl-6 mt-6 md:mt-0 flex flex-col justify-center">
