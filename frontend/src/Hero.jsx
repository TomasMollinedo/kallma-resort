...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden absolute inset-0 flex items-center justify-center text-white">
        <div className="flex flex-col items-center max-w-md px-6">
          ...
          <button
            className="flex items-center bg-gray-600/70 hover:bg-gray-500/80 text-white font-medium px-5 py-2.5 md:px-6 md:py-3 rounded-full shadow-xl hover:shadow-2xl transition duration-300 mb-8"
          ...
          {weather && (
            <div className="flex items-center space-x-3 text-base md:text-lg font-semibold text-gray-200 mb-4">
          ...
          <div className="flex items-center space-x-3 text-base md:text-lg font-semibold text-center">
            ...
            <Wind className="w-8 h-8 md:w-9 md:h-9 text-gray-200" />
          </div>
        </div>
      </div>

      {/* Contenido principal - Desktop con grid para alineación exacta */}
